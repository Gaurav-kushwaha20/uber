...
const RidePopUp = (props) => {
    return (
        <div
            className={`${props.ridePopUp ? '' : 'translate-y-full'} absolute bottom-0 w-full bg-white py-3 transform duration-500`}>

            <div className={'w-[80vw] h-full  mx-auto pt-5 bg-gray-100  shadow-2xl shadow-gray-300 rounded-lg'}>
                <p className={'text-2xl font-semibold text-center'}>New Ride Available!</p>
                ...
                <div className={'flex flex-col gap-3 mt-5'}>
                    <button
                        ...
                        className={'w-full bg-green-500 py-2 rounded-3xl text-xl font-semibold text-white'}>Confirm
                    </button>
                    <button onClick={() => {
                        props.setRidePopUp(false)

                    }} className={'w-full bg-gray-400 py-2 rounded-3xl text-xl font-semibold text-white'}>Ignore
                    </button>
                </div>
            </div>
        </div>
