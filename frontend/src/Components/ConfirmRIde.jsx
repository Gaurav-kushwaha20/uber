...
const ConfirmRIde = (props) => {
    return (<div className={`${props.vehicleRide ? '' : 'translate-y-full'} absolute bottom-0 h-[70vh] w-full bg-white py-3 transform duration-500`}>
        ...
        <div className={'w-[80vw] h-full  mx-auto pt-5 bg-gray-100  shadow-2xl shadow-gray-300 rounded-lg'}>
            ...
            <div className={'flex justify-center mt-5'}>
                <button onClick={()=>{props.setLookingForDriver(true); props.setConfirmRide(false)}} className={'bg-green-300 px-4 py-2 rounded-lg mx-auto text-xl font-semibold'}>Confirm</button>
            </div>
